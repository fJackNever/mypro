  ...
  GetRentReocrd = (target) =>{
    ...
    request('/api/web/vehicle/getPolicyInfo',{
      ...
      if(data.data.code==1){
        ...
        if(data.data.data.insurance_policy_no!="undefined"){
          this.props.form.setFields({
            insurance_policy_no:{value:data.data.data.insurance_policy_no},
          })
        }
        if(data.data.data.commercial_insurance_policy_no!="undefined"){
          this.props.form.setFields({
        ...
        if(this.state.ADDNewRoecord==1){
          ...
          request('/api/web/vehicle/addPolicy',{
            ...
            if(data.data.code==1){
              ...
              this.props.history.push('/workbench/InsuranceCommissioner/CheckReocrd?car_id='+data.data.data.vehicle_id)
            }else{
